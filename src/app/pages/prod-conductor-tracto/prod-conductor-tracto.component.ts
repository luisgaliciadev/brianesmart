...
@Component({
  selector: 'app-prod-conductor-tracto',
  templateUrl: './prod-conductor-tracto.component.html',
  styles: [
  ]
})
export class ProdConductorTractoComponent implements OnInit {
  ...
  async getProductividad() {
    ...
    this.spinner.show();
    this._registerService.getProductividadConductorTracto(this.fhDesde, this.fhHasta, this.idZona, search).subscribe(
      (response: any) => {
        this.desde = 0;
        this.hasta = 5;
        this.pagina = 1;
