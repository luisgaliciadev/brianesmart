...
export const pagesRoutes: Routes = [
    ...
    { 
        ...
        canActivate: [RenewTokenGuard], data: {titulo: 'Registro de Viáticos'}
    },
    { 
        path: 'viaticos', component: ViaticosComponent, 
        canActivate: [RenewTokenGuard], data: {titulo: 'Viáticos'}
    },
    { 
        path: 'guia/:id', component: GuiaComponent, 
        canActivate: [RenewTokenGuard], data: {titulo: 'Registro de Guía'}
    },
    { 
        path: 'guias', component: GuiasComponent, 
        canActivate: [RenewTokenGuard], data: {titulo: 'Guías'}
    },
    { 
    ...
    { 
        ...
        canActivate: [RenewTokenGuard], data: {titulo: 'Consulta de viáticos'}
    },
    { 
        path: 'consultaguias', component: ConsultaGuiasComponent, 
        canActivate: [RenewTokenGuard], data: {titulo: 'Consulta de Guías'}
    },
    { 
        path: 'consultaguia/:id', component: ConsultaGuiaComponent, 
        canActivate: [RenewTokenGuard], data: {titulo: 'Consulta de Guía'}
    },
    { 
    ...
    { 
        ...
        canActivate: [RenewTokenGuard], data: {titulo: 'Directorio Telefónico'}
    },
    { 
    ...
    { 
        ...
        canActivate: [RenewTokenGuard], data: {titulo: 'Homologación de Conductor'}
    },
    { 
    ...
    { 
        ...
        canActivate: [RenewTokenGuard], data: {titulo: 'Homologación de Unidad'}
    },
    { 
    ...
    { 
        ...
        canActivate: [RenewTokenGuard], data: {titulo: 'Planificación Operaciones'}
    },
    { 
    ...
    { 
        ...
        canActivate: [RenewTokenGuard], data: {titulo: 'Asignación de Guía'}
    },
    { 
    ...
    { 
        ...
        canActivate: [RenewTokenGuard], data: {titulo: 'Guías con Diferencia de Peso'}
    },
    { 
    ...
    { 
        ...
        canActivate: [RenewTokenGuard], data: {titulo: 'Dashboard Desempeño por Tracto'}
    },     
    { 
        path: 'dashboardkpimandismec', component: DashboardKpimandismecComponent, 
        canActivate: [RenewTokenGuard], data: {titulo: 'Dashboard Disponibilidad Mecánica'}
    },     
    { 
    ...
    { 
        ...
        canActivate: [AdminGuard, RenewTokenGuard, UserGuard], data: {titulo: 'Administración de Modulos'}
    },
    { 
    ...
    { 
        ...
        canActivate: [AdminGuard, RenewTokenGuard],data: {titulo: 'Administración de Usuario'}
    },
    { 
