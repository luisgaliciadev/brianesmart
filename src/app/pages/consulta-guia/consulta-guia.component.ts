...
@Component({
  selector: 'app-consulta-guia',
  templateUrl: './consulta-guia.component.html',
  styles: [
  ]
})
export class ConsultaGuiaComponent implements OnInit {
  ...
  getGuia() {
    this._registerService.getGuia(this.guia.ID_GUIA, 0).subscribe(
      (response: any) => {
